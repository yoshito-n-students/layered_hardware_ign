#ifndef LAYERED_HARDWARE_GZ_VELOCITY_MODE_HPP
#define LAYERED_HARDWARE_GZ_VELOCITY_MODE_HPP
...
public:
  VelocityMode(const std::shared_ptr<GazeboSimJointContext> &context)
